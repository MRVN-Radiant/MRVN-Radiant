...
void WriteR1BSPFile( const char* filename ) {
	...
	AddLump(file, header.lumps[R1_LUMP_CM_GRID],							Titanfall::Bsp::cmGrid_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_GRID_CELLS],						Titanfall::Bsp::cmGridCells_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_GRID_SETS],						Titanfall::Bsp::cmGridSets_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_GEO_SET_BOUNDS],					Titanfall::Bsp::cmGeoSetBounds_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_UNIQUE_CONTENTS],					Titanfall::Bsp::cmUniqueContents_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_BRUSHES],							Titanfall::Bsp::cmBrushes_stub);
	AddLump(file, header.lumps[R1_LUMP_CM_BRUSH_SIDE_PROPS],				Titanfall::Bsp::cmBrushSideProps_stub);
...
void Titanfall::EmitStubs() {
	...
	// CMGrid
	{
		constexpr std::array<uint8_t, 28> data = {
			0x00, 0x00, 0x80, 0x43, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x02, 0x00, 0x00, 0x00,
			0x02, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
		};
		Titanfall::Bsp::cmGrid_stub = { data.begin(), data.end() };
	}

	// CMGrid Cells
	{
		constexpr std::array<uint8_t, 20> data = {
			0x00, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x08, 0x00, 0x04, 0x00, 0x0C, 0x00, 0x04, 0x00,
			0x10, 0x00, 0x00, 0x00
		};
		Titanfall::Bsp::cmGridCells_stub = { data.begin(), data.end() };
	}

	// CMGeo Sets
	{
		constexpr std::array<uint8_t, 128> data = {
			
		};
		Titanfall::Bsp::cmGridSets_stub = { data.begin(), data.end() };
	}

	// CMGeo Set Bounds
	{
		constexpr std::array<uint8_t, 256> data = {
			,
		...
		Titanfall::Bsp::cmGeoSetBounds_stub = { data.begin(), data.end() };
	}
	...
	// CMBrushes
	{
		constexpr std::array<uint8_t, 192> data = {
			
		};
		Titanfall::Bsp::cmBrushes_stub = { data.begin(), data.end() };
	}

	// CMBrush Side Props
	{
		constexpr std::array<uint8_t, 72> data = {
			0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x80,
			0x01, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x80, 0x01, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x80,
			0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x00, 0x01, 0x00,
			0x00, 0x80, 0x00, 0x80, 0x00, 0x00, 0x01, 0x00, 0x00, 0x80, 0x00, 0x80, 0x00, 0x00, 0x01, 0x00,
			0x00, 0x80, 0x00, 0x80, 0x00, 0x80, 0x00, 0x80
		};
		Titanfall::Bsp::cmBrushSideProps_stub = { data.begin(), data.end() };
	}
