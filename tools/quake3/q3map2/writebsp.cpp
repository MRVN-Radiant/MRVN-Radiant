...
void EmitStubs()
{
	...
	{
		constexpr std::array<uint8_t, 96> data = {
			0xD7, 0xFF, 0x3F, 0xC5, 0xD7, 0xFF, 0x3F, 0xC5, 0xD7, 0xFF, 0x3F, 0xC5, 0x02, 0x00, 0x02, 0x00,
			0xD7, 0xFF, 0x3F, 0x45, 0xD7, 0xFF, 0x3F, 0x45, 0xD7, 0xFF, 0x3F, 0x45, 0x01, 0x00, 0x00, 0x00,
			0xD7, 0xFF, 0x3F, 0xC5, 0xD7, 0xFF, 0x3F, 0xC5, 0x00, 0x00, 0x3C, 0xC5, 0x00, 0x01, 0x01, 0x00,
			0xD7, 0xFF, 0x3F, 0x45, 0xD7, 0xFF, 0x3F, 0x45, 0x00, 0x00, 0x3C, 0xC5, 0x00, 0x00, 0x00, 0x00,
			0x0A, 0xD7, 0x7F, 0xC1, 0xB8, 0xFE, 0xAF, 0xC3, 0xD7, 0xFF, 0x3F, 0xC5, 0x00, 0x01, 0x01, 0x00,
			0x0A, 0xD7, 0x7F, 0x41, 0x48, 0x01, 0xA0, 0xC3, 0x29, 0x00, 0x3E, 0xC5, 0x00, 0x00, 0x01, 0x00
		};
		bspCellAABBNodes_stub = { data.begin(), data.end() };
	}
	/* Obj References */
	{
		...
		bspObjReferences_stub = { data.begin(), data.end() };
	}
	/* Obj Reference Bounds */
	{
		constexpr std::array<uint8_t, 64> data = {
			0xD7, 0xFF, 0x3F, 0xC5, 0xD7, 0xFF, 0x3F, 0xC5, 0x00, 0x00, 0x3C, 0xC5, 0x00, 0x00, 0x00, 0x00,
			0xD7, 0xFF, 0x3F, 0x45, 0xD7, 0xFF, 0x3F, 0x45, 0x00, 0x00, 0x3C, 0xC5, 0x00, 0x00, 0x00, 0x00,
			0x0A, 0xD7, 0x7F, 0xC1, 0xB8, 0xFE, 0xAF, 0xC3, 0xD7, 0xFF, 0x3F, 0xC5, 0x00, 0x00, 0x00, 0x00,
			0x0A, 0xD7, 0x7F, 0x41, 0x48, 0x01, 0xA0, 0xC3, 0x29, 0x00, 0x3E, 0xC5, 0x00, 0x00, 0x00, 0x00
		};
		bspObjReferenceBounds_stub = { data.begin(), data.end() };
	}
	/* Level Info */
	{
		constexpr std::array<uint8_t, 28> data = {
			0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0xC7, 0xEB, 0x8B, 0x3E, 0xEB, 0xD3, 0x05, 0xBF, 0x62, 0xB7, 0x4E, 0xBF
		};
		bspLevelInfo_stub = { data.begin(), data.end() };
	}
}
/*
   BeginModel()
